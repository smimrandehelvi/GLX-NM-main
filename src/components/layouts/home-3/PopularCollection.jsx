                    ...
                    <div className="sc-card-collection">
                        <Link to="/authors-01">
                            <div className="media-images-box">
                                <img src={props.item.imgtop} alt="Galaxy" />
                                <div className="bottom-media">
                                    <img src={props.item.imgright1} alt="Galaxy" />
                                    <img src={props.item.imgright2} alt="Galaxy" />
                                    <img src={props.item.imgright3} alt="Galaxy" />
                                </div>
                            </div>
                        </Link>
                            ...
                            <div className="author">
                                <div className="sc-author-box style-2">
                                    <div className="author-avatar">
                                        <img src={props.item.imgAuthor} alt="Galaxy" className="avatar" />
